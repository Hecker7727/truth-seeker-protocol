...
const Footer = () => {
  ...
  return (
    <footer className="glass-card mt-16 py-8 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Resources */}
          <div>
            <h3 className="text-sm font-semibold text-sc-violet mb-4">Resources</h3>
            <ul className="space-y-2">
              <li><Link to="/learn" className="text-sm text-gray-400 hover:text-white">Learn</Link></li>
              <li><Link to="/trust" className="text-sm text-gray-400 hover:text-white">Trust & Safety</Link></li>
          ...
          {/* Legal */}
          <div>
            <h3 className="text-sm font-semibold text-sc-mint mb-4">Legal</h3>
            <ul className="space-y-2">
